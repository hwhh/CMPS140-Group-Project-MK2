...
def plotstft(audiopath, binsize=2 ** 10, plotpath=None, colormap="gray", channel=0, name='tmp.png', alpha=1, offset=0):
    samplerate, samples = wav.read('../input/audio_train/'+audiopath)
...
for iter, line in enumerate(
    ...
    filename = filepath[:-4]
    wavfile = 'tmp.wav'
    # os.system('mpg123 -w ' + wavfile + '/Users/henryhargreaves/Documents/University/Year_3/CMPS140/Group '
    #                                    'Project/Google ML Engine and ResNet/input/audio_train' + filepath)
    """
    ...
    plotstft(filepath, channel=0, name='../input/audio_triain_png/' + filename + '.png', alpha=1.0)
    os.remove(wavfile)
