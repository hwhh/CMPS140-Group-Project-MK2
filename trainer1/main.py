...
from trainer1.test import Network
...
parser.add_argument('--forward_cnt', type=int, default=1,
                    help='if forward pass is nondeterministic, then how many forward passes are averaged')
...
train_listfile = open(
    "/Users/henryhargreaves/Documents/University/Year_3/CMPS140/Group Project/Google ML Engine and ResNet/input/train.csv",
    "r")
test_listfile = open(
    "/Users/henryhargreaves/Documents/University/Year_3/CMPS140/Group Project/Google ML Engine and ResNet/input/sample_submission.csv",
    "r")
...
# network_module = importlib.import_module("test.py")
network = Network()
    ...
    if mode == "predict":
        ...
        with open(pred_filename, 'w') as pred_csv:
            for x in all_prediction:
                print(",".join([("%.6f" % prob) for prob in x]))
